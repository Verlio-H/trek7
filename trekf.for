...
CV IF M-O SHIP NOT IN GAME: NEXT M-O SHIP
      ...
      I7=IV*2+3
      WRITE(1+I7,207)(IENM2(N,J),N=1,4)
...
1     WRITE(1+L,3)NA,(IDEX(J,I,M),M=1,K)
3     FORMAT(A1,1X,20A4)
      RETURN
      END
...
4021  IF(K(1,10).GT.4)GO TO 4015
      WRITE(1+L,4023)
4023  FORMAT(' SPOCK HAS MADE DR. MCCOY AN HONOURARY VULCAN',/,' BY STUF
     *FING HIS EARS IN A PENCIL SHARPENER')
