...
CV IF C-O SHIP CAUGHT IN WEB OF ...: CV NEXT C-O SHIP
      IF(IWEB(1).EQ.I*2+3)GO TO 1000

CV IF C-O SHIP CAUGHT IN WEB OF ...: CV NEXT C-O SHIP
      IF(IWEB(2).EQ.I*2+3)GO TO 1000

CV
C      IF(IO.EQ.1)TYPE 1970,I
C1970  FORMAT(' BEGIN ATACK I=',I)
      if (IO == 1) write (*, *) 'BEGIN ATACK I=', I
...
10101 CALL HORTA(IKLNR(I),IKLNC(I),MM,MN,RAD,BERNG,
     *ITZRO,AJUST,IGNORE,DIST(I),ITZRO_array)
C      IF(IO.EQ.1)TYPE 1972,MIN,I7,I8,DISTP
      if (io == 1) print 1972, min, i7, i8, distp
1972  FORMAT(' MIN=',I0,' I7=',I0,' I8=',I0,' DISTP=',F0.5)
...
CV
      IF(MIN.NE.I*2+3.AND.MIN.NE.19.AND.MIN.LT.21)GO TO 10801
...
1061  DO 535 IV=1,4
      ...
      L=IV*2+3
      WRITE(1+L,1062)(INAME(IQ0,MIN),IQ0=1,3)
...
CV WRITE MESSAGE "ROMULAN SHIP ATTACKING"
      IF(MIN.LT.5.AND.IV.NE.0)WRITE(1+I71,10032)
...
CV WRITE MESSAGE "ROMULAN SHIP RETREATING"
      IF(MIN.LT.5.AND.IV.NE.0)WRITE(1+I71,10033)
...
CV "DOOMSDAY MACHINE HAS EATEN <OPPONENT SIDE NAME> STARBASE <NO>"
      WRITE(1+I71,521)(ISIDE(IQ0,IV),IQ0=1,3),IBASE(IV)
...
C516   IF(ISMINE.EQ..FALSE.)GO TO 599
516   IF(.NOT.ISMINE)GO TO 599
...
CV INFORM M-O SHIPS
      ...
      IV=IVV*2+3
      WRITE(1+IV,527)(INAME(IQ0,MIN),IQ0=1,3)
...
CV INFORM M-O SHIPS
      ...
      IV=IVV*2+3
      WRITE(1+IV,532)(IENM2(J,MIN),J=1,4)
...
CV DOOMSDAY EDIBILITY
     ...
     *IBASR(2),IBASC(2),LI2(4),LI2R(5),LI2C(5),IGO(4),MINES
      ...
      COMMON /R/IBPSC(4),IBPSB(8),IBPSS(2),IBPSE(25)
      character(4) :: na
      character(4) :: iblk, iii, istar, map
...
C      IF(IO.EQ.1)TYPE 1978,J1,J2,BDIS
      if (io == 1) print 1978, J1, J2, BDIS
C1978  FORMAT(' BEGIN ALPHA J1=',I5,' J2=',I5,' BDIS=',F)
1978  FORMAT(' BEGIN ALPHA J1=',I5,' J2=',I5,' BDIS=',F0.5)
...
7     N=4
     ...
     *ITZRO,ITZRO,RAD,BERNG,ITZRO,AJUST,IGNORE,RTZRO,ITZRO_array)

CV
C      IF(IO.EQ.1)TYPE 1979,IVV,MIN,I7,I8
      IF(IO.EQ.1) print 1979,IVV,MIN,I7,I8
...
6     I71=I7
     ...
     *RTVL1,RTZRO,ITZRO,RTZRO,IGNORE,RTZRO,ITZRO_array)
...
123   DO 124 MIN=1,4
      ...
      N=MIN*2+3
      WRITE(1+N,103)I8,(INAME(IQ0,JTK),IQ0=1,3),I8,
